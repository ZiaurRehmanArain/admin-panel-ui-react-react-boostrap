...
const handleDateChange = (date) => {
    ...
    return <>
        <Container className="mt-2 ">
            ...
            <h5 className="bg-light-orange text-start p-2 text-light-grey mt-3">
                Row 1
            </h5>
            <h5 className="text-start p-2 text-light-grey">
                Row 1
            </h5>
            <h5 className="bg-light-orange text-start p-2 text-light-grey">
                Row 1
            </h5>
        </Container>
    </>;
